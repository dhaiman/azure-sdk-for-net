...
namespace Microsoft.Azure.Management.NotificationHubs.Models
{
    ...
    public partial class DebugSendResponse : Resource
    {
        ...
        public DebugSendResponse(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), double? success = default(double?), double? failure = default(double?), object results = default(object))
