...
namespace Microsoft.Azure.Management.ContainerRegistry
{
    ...
    public static partial class PrivateEndpointConnectionsOperationsExtensions
    {
            ...
            /// </param>
            public static PrivateEndpointConnection CreateOrUpdate(this IPrivateEndpointConnectionsOperations operations, string resourceGroupName, string registryName, string privateEndpointConnectionName, PrivateEndpointConnectionProperties properties = default(PrivateEndpointConnectionProperties))
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, registryName, privateEndpointConnectionName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async System.Threading.Tasks.Task<PrivateEndpointConnection> CreateOrUpdateAsync(this IPrivateEndpointConnectionsOperations operations, string resourceGroupName, string registryName, string privateEndpointConnectionName, PrivateEndpointConnectionProperties properties = default(PrivateEndpointConnectionProperties), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(resourceGroupName, registryName, privateEndpointConnectionName, properties, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The properties of a private endpoint connection.
            /// </param>
            public static PrivateEndpointConnection BeginCreateOrUpdate(this IPrivateEndpointConnectionsOperations operations, string resourceGroupName, string registryName, string privateEndpointConnectionName, PrivateEndpointConnectionProperties properties = default(PrivateEndpointConnectionProperties))
            {
                return operations.BeginCreateOrUpdateAsync(resourceGroupName, registryName, privateEndpointConnectionName, properties).GetAwaiter().GetResult();
            }
            ...
            {
                using (var _result = await operations.BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, registryName, privateEndpointConnectionName, properties, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
