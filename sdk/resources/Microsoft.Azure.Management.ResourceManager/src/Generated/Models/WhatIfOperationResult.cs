...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class WhatIfOperationResult
    {
        ...
        /// <param name="correlationId">The correlation ID of the What-If
        /// operation.</param>
        ...
        public WhatIfOperationResult(string status = default(string), string correlationId = default(string), IList<WhatIfChange> changes = default(IList<WhatIfChange>), ErrorResponse error = default(ErrorResponse))
        {
            Status = status;
        ...
        /// <summary>
        /// Gets or sets the correlation ID of the What-If operation.
        /// </summary>
