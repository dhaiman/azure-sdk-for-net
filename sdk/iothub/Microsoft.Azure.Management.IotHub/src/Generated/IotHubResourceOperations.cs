...
namespace Microsoft.Azure.Management.IotHub
{
    ...
    internal partial class IotHubResourceOperations : IServiceOperations<IotHubClient>, IIotHubResourceOperations
    {
        ...
        {
            // Send request
            AzureOperationResponse<IotHubDescription> _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, resourceName, customHeaders, cancellationToken).ConfigureAwait(false);
