...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class PrivateEndpointConnectionOperationsExtensions
    {
            ...
            /// </param>
            public static PrivateEndpointConnectionResource ApprovesOrRejects(this IPrivateEndpointConnectionOperations operations, string resourceGroupName, string factoryName, string privateEndpointConnectionName, PrivateLinkConnectionApprovalRequestResource privateEndpointWrapper, string ifMatch = default(string))
            {
                return operations.ApprovesOrRejectsAsync(resourceGroupName, factoryName, privateEndpointConnectionName, privateEndpointWrapper, ifMatch).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<PrivateEndpointConnectionResource> ApprovesOrRejectsAsync(this IPrivateEndpointConnectionOperations operations, string resourceGroupName, string factoryName, string privateEndpointConnectionName, PrivateLinkConnectionApprovalRequestResource privateEndpointWrapper, string ifMatch = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ApprovesOrRejectsWithHttpMessagesAsync(resourceGroupName, factoryName, privateEndpointConnectionName, privateEndpointWrapper, ifMatch, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
