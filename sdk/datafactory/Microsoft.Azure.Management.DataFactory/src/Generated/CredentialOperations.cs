...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    internal partial class CredentialOperations : IServiceOperations<DataFactoryManagementClient>, ICredentialOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<CredentialResource>>> ListByFactoryWithHttpMessagesAsync(string resourceGroupName, string factoryName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<CredentialResource>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<CredentialResource>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<CredentialResource>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string factoryName, string credentialName, CredentialResource credential, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
            ...
            if (credentialName != null)
            {
                ...
                if (!System.Text.RegularExpressions.Regex.IsMatch(credentialName, "^[A-Za-z0-9_][^<>*#.%&:\\\\+?/]*$"))
                {
                    throw new ValidationException(ValidationRules.Pattern, "credentialName", "^[A-Za-z0-9_][^<>*#.%&:\\\\+?/]*$");
                }
            }
            if (Client.ApiVersion == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<CredentialResource>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<CredentialResource>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<CredentialResource>> GetWithHttpMessagesAsync(string resourceGroupName, string factoryName, string credentialName, string ifNoneMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<CredentialResource>>> ListByFactoryNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
