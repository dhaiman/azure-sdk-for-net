...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    internal partial class PrivateEndpointConnectionOperations : IServiceOperations<DataFactoryManagementClient>, IPrivateEndpointConnectionOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<PrivateEndpointConnectionResource>> ApprovesOrRejectsWithHttpMessagesAsync(string resourceGroupName, string factoryName, string privateEndpointConnectionName, PrivateLinkConnectionApprovalRequestResource privateEndpointWrapper, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "ApprovesOrRejects", tracingParameters);
            }
            // Construct URL
