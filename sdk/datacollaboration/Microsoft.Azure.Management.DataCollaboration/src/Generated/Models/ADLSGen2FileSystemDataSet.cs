...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class ADLSGen2FileSystemDataSet : DataSet
    {
        ...
        /// resource</param>
        public ADLSGen2FileSystemDataSet(string fileSystem, string storageAccountId, string id = default(string), string name = default(string), string type = default(string), string dataSetId = default(string))
            : base(id, name, type)
        {
            DataSetId = dataSetId;
