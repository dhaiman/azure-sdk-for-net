...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class Workspace : DefaultDto
    {
        ...
        public Workspace(Identity identity, string id = default(string), string location = default(string), string name = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string type = default(string), string provisioningState = default(string), string userEmail = default(string), string userName = default(string), SystemData systemData = default(SystemData))
