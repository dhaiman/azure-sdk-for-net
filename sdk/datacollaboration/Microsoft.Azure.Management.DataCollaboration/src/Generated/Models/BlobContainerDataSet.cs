...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class BlobContainerDataSet : DataSet
    {
        ...
        /// resource</param>
        public BlobContainerDataSet(string containerName, string storageAccountId, string id = default(string), string name = default(string), string type = default(string), string dataSetId = default(string))
            : base(id, name, type)
        {
