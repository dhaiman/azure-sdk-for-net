...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class DataAssetReference : ProxyDto
    {
        ...
        public DataAssetReference(string dataAssetId, string id = default(string), string name = default(string), string type = default(string), string dataAssetReferenceId = default(string), string description = default(string), string ownerId = default(string), SystemData systemData = default(SystemData))
            : base(id, name, type)
        {
