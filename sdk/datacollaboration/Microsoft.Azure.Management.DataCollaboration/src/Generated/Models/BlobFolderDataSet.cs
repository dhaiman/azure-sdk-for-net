...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class BlobFolderDataSet : DataSet
    {
        ...
        /// resource</param>
        public BlobFolderDataSet(string containerName, string prefix, string storageAccountId, string id = default(string), string name = default(string), string type = default(string), string dataSetId = default(string))
            : base(id, name, type)
        {
