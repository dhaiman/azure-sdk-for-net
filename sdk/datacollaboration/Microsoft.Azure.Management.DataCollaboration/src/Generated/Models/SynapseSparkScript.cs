...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class SynapseSparkScript : Script
    {
        ...
        /// resource</param>
        public SynapseSparkScript(string content, IList<string> sinks, IList<string> sources, string visibility, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string provisioningState = default(string), int? revision = default(int?), string scriptId = default(string))
