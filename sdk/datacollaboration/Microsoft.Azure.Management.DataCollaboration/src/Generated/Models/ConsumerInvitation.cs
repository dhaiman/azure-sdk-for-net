...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class ConsumerInvitation : ProxyDto
    {
        ...
        /// resource</param>
        public ConsumerInvitation(string invitationId, string id = default(string), string name = default(string), string type = default(string), string location = default(string), string description = default(string), string invitationStatus = default(string), string proposalName = default(string), string providerEmail = default(string), string providerName = default(string), string providerTenantName = default(string), System.DateTime? respondedAt = default(System.DateTime?), System.DateTime? sentAt = default(System.DateTime?), string termsOfUse = default(string), string userEmail = default(string), string userName = default(string))
            : base(id, name, type)
        {
            Location = location;
