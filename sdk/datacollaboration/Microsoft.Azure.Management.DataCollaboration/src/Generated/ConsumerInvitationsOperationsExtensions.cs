...
namespace Microsoft.Azure.Management.DataCollaboration
{
    ...
    public static partial class ConsumerInvitationsOperationsExtensions
    {
            ...
            /// An invitation id
            /// </param>
            public static ConsumerInvitation RejectInvitation(this IConsumerInvitationsOperations operations, string location, string invitationId)
            {
                return operations.RejectInvitationAsync(location, invitationId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ConsumerInvitation> RejectInvitationAsync(this IConsumerInvitationsOperations operations, string location, string invitationId, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.RejectInvitationWithHttpMessagesAsync(location, invitationId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
