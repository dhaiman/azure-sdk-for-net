...
namespace Microsoft.Azure.Management.DataCollaboration
{
    ...
    public partial interface IConsumerInvitationsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<ConsumerInvitation>> RejectInvitationWithHttpMessagesAsync(string location, string invitationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List the invitations
        /// </summary>
        /// <remarks>
