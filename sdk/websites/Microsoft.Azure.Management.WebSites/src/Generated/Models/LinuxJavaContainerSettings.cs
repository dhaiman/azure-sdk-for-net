...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class LinuxJavaContainerSettings
    {
        ...
        /// &lt;code&gt;false&lt;/code&gt;.</param>
        public LinuxJavaContainerSettings(string java11Runtime = default(string), string java8Runtime = default(string), bool? isPreview = default(bool?), bool? isDeprecated = default(bool?), bool? isHidden = default(bool?), string endOfLifeDate = default(string), bool? isAutoUpdate = default(bool?), bool? isEarlyAccess = default(bool?))
        {
        ...
        /// <summary>
        /// Gets or sets java 11 version (runtime only).
        /// </summary>
        [JsonProperty(PropertyName = "java11Runtime")]
        public string Java11Runtime { get; set; }

        /// <summary>
        /// Gets or sets java 8 version (runtime only).
        /// </summary>
