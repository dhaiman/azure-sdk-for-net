...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class IpSecurityRestriction
    {
        ...
        public IpSecurityRestriction(string ipAddress = default(string), string subnetMask = default(string), string vnetSubnetResourceId = default(string), int? vnetTrafficTag = default(int?), int? subnetTrafficTag = default(int?), string action = default(string), IpFilterTag? tag = default(IpFilterTag?), int? priority = default(int?), string name = default(string), string description = default(string), IDictionary<string, IList<string>> headers = default(IDictionary<string, IList<string>>))
        {
            IpAddress = ipAddress;
