...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class WebAppMinorVersion
    {
        ...
        /// <summary>
        /// Gets or sets web App stack minor version (display only).
        /// </summary>
        [JsonProperty(PropertyName = "displayText")]
        public string DisplayText { get; set; }

        /// <summary>
        /// Gets or sets web App stack major version name.
        /// </summary>
        [JsonProperty(PropertyName = "value")]
        public string Value { get; set; }

        /// <summary>
        /// Gets or sets settings associated with the minor version.
        /// </summary>
        [JsonProperty(PropertyName = "stackSettings")]
        public WebAppRuntimes StackSettings { get; set; }
