...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class WindowsJavaContainerSettings
    {
        ...
        /// &lt;code&gt;false&lt;/code&gt;.</param>
        public WindowsJavaContainerSettings(string javaContainer = default(string), string javaContainerVersion = default(string), bool? isPreview = default(bool?), bool? isDeprecated = default(bool?), bool? isHidden = default(bool?), string endOfLifeDate = default(string), bool? isAutoUpdate = default(bool?), bool? isEarlyAccess = default(bool?))
        {
        ...
        /// <summary>
        /// Gets or sets java container (runtime only).
        /// </summary>
        [JsonProperty(PropertyName = "javaContainer")]
        public string JavaContainer { get; set; }

        /// <summary>
        /// Gets or sets java container version (runtime only).
        /// </summary>
