...
namespace Microsoft.Azure.Management.Bing
{
    ...
    /// </summary>
    internal partial class SkusOperations : IServiceOperations<BingManagementClient>, ISkusOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal SkusOperations(BingManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<ResourceSku>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.Bing/skus").ToString();
