...
namespace Microsoft.Azure.Management.Bing.Models
{
    ...
    /// </summary>
    public partial class BingAccountKeys
    {
        /// <summary>
        /// Initializes a new instance of the BingAccountKeys class.
        /// </summary>
        public BingAccountKeys()
        {
            CustomInit();
        }
        ...
        public BingAccountKeys(string key1 = default(string), string key2 = default(string))
        {
            Key1 = key1;
            Key2 = key2;
            CustomInit();
