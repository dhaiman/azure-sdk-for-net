...
namespace Microsoft.Azure.Management.Bing.Models
{
    ...
    public partial class MetricSpecification
    {
        ...
        public MetricSpecification(string name = default(string), string displayName = default(string), string displayDescription = default(string), string unit = default(string), string category = default(string), string aggregationType = default(string), IList<Availability> availabilities = default(IList<Availability>), IList<string> supportedAggregationTypes = default(IList<string>), IList<string> supportedTimeGrainTypes = default(IList<string>), bool? fillGapWithZero = default(bool?), IList<MetricDimension> dimensions = default(IList<MetricDimension>))
        {
            Name = name;
