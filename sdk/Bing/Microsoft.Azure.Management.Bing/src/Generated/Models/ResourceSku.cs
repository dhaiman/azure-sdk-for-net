...
namespace Microsoft.Azure.Management.Bing.Models
{
    ...
    public partial class ResourceSku
    {
        ...
        /// <param name="tier">Specifies the tier of Bing account.</param>
        ...
        public ResourceSku(string resourceType = default(string), string name = default(string), string tier = default(string), string kind = default(string), IList<string> locations = default(IList<string>), IList<ResourceSkuLocationInfo> locationInfo = default(IList<ResourceSkuLocationInfo>), IList<ResourceSkuRestrictions> restrictions = default(IList<ResourceSkuRestrictions>))
        {
        ...
        /// <summary>
        /// Gets specifies the tier of Bing account.
        /// </summary>
