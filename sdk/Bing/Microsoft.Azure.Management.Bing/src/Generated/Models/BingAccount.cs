...
namespace Microsoft.Azure.Management.Bing.Models
{
    ...
    /// <summary>
    /// Bing Account is an Azure resource representing the provisioned account,
    /// its type, location and SKU.
    /// </summary>
    public partial class BingAccount : IResource
    {
        /// <summary>
        /// Initializes a new instance of the BingAccount class.
        /// </summary>
        public BingAccount()
        {
            CustomInit();
        ...
        /// <param name="properties">Properties of Bing account.</param>
        /// <param name="sku">The SKU of Bing account.</param>
        ...
        public BingAccount(string etag = default(string), string id = default(string), string kind = default(string), string location = default(string), string name = default(string), BingAccountProperties properties = default(BingAccountProperties), Sku sku = default(Sku), IDictionary<string, string> tags = default(IDictionary<string, string>), string type = default(string))
        {
            Etag = etag;
            Id = id;
            Kind = kind;
        ...
        /// <summary>
        /// Gets or sets properties of Bing account.
        /// </summary>
        [JsonProperty(PropertyName = "properties")]
        public BingAccountProperties Properties { get; set; }

        /// <summary>
        /// Gets or sets the SKU of Bing account.
        /// </summary>
