...
namespace Microsoft.Azure.Management.Bing
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<BingManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(BingManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<OperationDetail>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Bing/operations").ToString();
