...
namespace Microsoft.Azure.Management.ApplicationInsights.Management
{
    ...
    public partial interface IWorkbooksOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<Workbook>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string resourceName, string sourceId, Workbook workbookProperties, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
