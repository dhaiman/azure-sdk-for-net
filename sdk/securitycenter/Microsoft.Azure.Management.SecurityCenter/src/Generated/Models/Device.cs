...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class Device : Resource
    {
        ...
        /// scanning.</param>
        /// <param name="fieldsChangedByUser">List of field names that their
        /// value was modified by the user.</param>
        public Device(string id = default(string), string name = default(string), string type = default(string), string displayName = default(string), string deviceType = default(string), string sourceName = default(string), IList<NetworkInterface> networkInterfaces = default(IList<NetworkInterface>), string vendor = default(string), string osName = default(string), IList<Protocol1> protocols = default(IList<Protocol1>), System.DateTime? lastActiveTime = default(System.DateTime?), System.DateTime? lastUpdateTime = default(System.DateTime?), string managementState = default(string), string authorizationState = default(string), string deviceCriticality = default(string), string purdueLevel = default(string), string notes = default(string), IList<Firmware> firmwares = default(IList<Firmware>), IList<string> vlans = default(IList<string>), System.DateTime? discoveryTime = default(System.DateTime?), string programmingState = default(string), System.DateTime? lastProgrammingTime = default(System.DateTime?), string scanningFunctionality = default(string), System.DateTime? lastScanTime = default(System.DateTime?), IList<string> fieldsChangedByUser = default(IList<string>))
            : base(id, name, type)
        {
        ...
        /// <summary>
        /// Gets list of field names that their value was modified by the user.
        /// </summary>
        [JsonProperty(PropertyName = "properties.fieldsChangedByUser")]
        public IList<string> FieldsChangedByUser { get; private set; }
