...
namespace Microsoft.Azure.Management.Security
{
    ...
    public static partial class IotDefenderSettingsOperationsExtensions
    {
            ...
            /// The operations group for this extension method.
            /// </param>
            public static void DownloadOnPremiseActivation(this IIotDefenderSettingsOperations operations)
            {
                operations.DownloadOnPremiseActivationAsync().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DownloadOnPremiseActivationAsync(this IIotDefenderSettingsOperations operations, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.DownloadOnPremiseActivationWithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
