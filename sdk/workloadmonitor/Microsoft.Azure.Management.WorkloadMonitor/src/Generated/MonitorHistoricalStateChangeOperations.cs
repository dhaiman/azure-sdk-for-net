...
namespace Microsoft.Azure.Management.WorkloadMonitor
{
    ...
    /// </summary>
    internal partial class MonitorHistoricalStateChangeOperations : IServiceOperations<WorkloadMonitorAPIClient>, IMonitorHistoricalStateChangeOperations
    {
        /// <summary>
        /// Initializes a new instance of the MonitorHistoricalStateChangeOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal MonitorHistoricalStateChangeOperations(WorkloadMonitorAPIClient client)
        {
            if (client == null)
            {
