...
namespace Microsoft.Azure.Management.WorkloadMonitor
{
    ...
    /// </summary>
    internal partial class MonitorInfoOperations : IServiceOperations<WorkloadMonitorAPIClient>, IMonitorInfoOperations
    {
        /// <summary>
        /// Initializes a new instance of the MonitorInfoOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal MonitorInfoOperations(WorkloadMonitorAPIClient client)
        {
            if (client == null)
            {
