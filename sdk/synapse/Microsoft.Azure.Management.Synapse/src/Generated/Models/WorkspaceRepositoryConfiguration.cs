...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class WorkspaceRepositoryConfiguration
    {
        ...
        public WorkspaceRepositoryConfiguration(string accountName = default(string), string collaborationBranch = default(string), string hostName = default(string), string projectName = default(string), string repositoryName = default(string), string rootFolder = default(string), string type = default(string))
        {
