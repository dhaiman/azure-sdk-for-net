      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_SynapseManagementClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("Synapse", "MaintenanceWindowOptions", "2019-06-01-preview"),
                new Tuple<string, string, string>("Synapse", "MaintenanceWindows", "2019-06-01-preview"),
