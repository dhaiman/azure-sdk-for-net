...
namespace Microsoft.Azure.Management.MachineLearning.Workspaces.Models
{
    ...
    public partial class WorkspaceUpdateParameters
    {
        ...
        public WorkspaceUpdateParameters(IDictionary<string, string> tags = default(IDictionary<string, string>), WorkspaceState? workspaceState = default(WorkspaceState?), string keyVaultIdentifierId = default(string), Sku sku = default(Sku))
        {
            Tags = tags;
