...
namespace Microsoft.Azure.Management.MachineLearning.WebServices
{
    ...
    public partial interface IWorkspacesOperations
    {
        ...
        /// The name of the resource group to which the machine learning
        /// workspace belongs.
        /// </param>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> ResyncStorageKeysWithHttpMessagesAsync(string workspaceName, string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<WorkspaceKeysResponse>> ListWorkspaceKeysWithHttpMessagesAsync(string workspaceName, string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
