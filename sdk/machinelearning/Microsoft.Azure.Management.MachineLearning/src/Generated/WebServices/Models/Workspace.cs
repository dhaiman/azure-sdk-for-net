...
namespace Microsoft.Azure.Management.MachineLearning.WebServices.Models
{
    ...
    public partial class Workspace : Resource
    {
        ...
        public Workspace(string location, string userStorageAccountId, string ownerEmail, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), WorkspaceType? workspaceType = default(WorkspaceType?), WorkspaceState? workspaceState = default(WorkspaceState?), string workspaceId = default(string), string creationTime = default(string), string studioEndpoint = default(string), string keyVaultIdentifierId = default(string))
