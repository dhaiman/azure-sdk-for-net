...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    /// </summary>
    internal partial class UsagesOperations : IServiceOperations<AzureMachineLearningWorkspacesDummyChangeClient>, IUsagesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal UsagesOperations(AzureMachineLearningWorkspacesDummyChangeClient client)
        {
            if (client == null)
            {
