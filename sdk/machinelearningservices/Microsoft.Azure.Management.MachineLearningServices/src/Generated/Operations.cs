...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AzureMachineLearningWorkspacesDummyChangeClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AzureMachineLearningWorkspacesDummyChangeClient client)
        {
            if (client == null)
            {
