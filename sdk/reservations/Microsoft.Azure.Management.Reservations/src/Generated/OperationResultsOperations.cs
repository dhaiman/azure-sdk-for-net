...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    /// </summary>
    internal partial class OperationResultsOperations : IServiceOperations<AzureReservationAPIClient>, IOperationResultsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal OperationResultsOperations(AzureReservationAPIClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<object,OperationResultsGetHeaders>> BeginGetWithHttpMessagesAsync(string operationResultId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Capacity/operationResults/{operationResultId}").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<object,OperationResultsGetHeaders>();
