...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    internal partial class ReservationOperations : IServiceOperations<AzureReservationAPIClient>, IReservationOperations
    {
        ...
        /// </param>
        public async Task<AzureOperationResponse<Properties>> AvailableScopesWithHttpMessagesAsync(string reservationOrderId, string reservationId, Scopes body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<Properties>> BeginAvailableScopesWithHttpMessagesAsync(string reservationOrderId, string reservationId, Scopes body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (reservationOrderId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "reservationOrderId");
