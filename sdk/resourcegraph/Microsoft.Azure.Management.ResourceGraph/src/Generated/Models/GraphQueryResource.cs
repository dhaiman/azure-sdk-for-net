...
namespace Microsoft.Azure.Management.ResourceGraph.Models
{
    ...
    public partial class GraphQueryResource : Resource
    {
        ...
        /// Concurrency.</param>
        public GraphQueryResource(string query, string id = default(string), string name = default(string), string location = default(string), string type = default(string), System.DateTime? timeModified = default(System.DateTime?), string description = default(string), string resultKind = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SystemData systemData = default(SystemData), string eTag = default(string))
        ...
        /// <summary>
        /// Gets or sets this will be used to handle Optimistic Concurrency.
        /// </summary>
