...
namespace Microsoft.Azure.Management.StreamAnalytics.Models
{
    ...
    public partial class ServiceBusQueueOutputDataSource : OutputDataSource
    {
        ...
        /// properties.</param>
        public ServiceBusQueueOutputDataSource(string serviceBusNamespace = default(string), string sharedAccessPolicyName = default(string), string sharedAccessPolicyKey = default(string), string queueName = default(string), IList<string> propertyColumns = default(IList<string>), IDictionary<string, string> systemPropertyColumns = default(IDictionary<string, string>))
        {
