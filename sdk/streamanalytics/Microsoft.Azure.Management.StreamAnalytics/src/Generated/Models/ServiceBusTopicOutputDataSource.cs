...
namespace Microsoft.Azure.Management.StreamAnalytics.Models
{
    ...
    public partial class ServiceBusTopicOutputDataSource : OutputDataSource
    {
        ...
        /// properties.</param>
        public ServiceBusTopicOutputDataSource(string serviceBusNamespace = default(string), string sharedAccessPolicyName = default(string), string sharedAccessPolicyKey = default(string), string topicName = default(string), IList<string> propertyColumns = default(IList<string>), IDictionary<string, string> systemPropertyColumns = default(IDictionary<string, string>))
        {
