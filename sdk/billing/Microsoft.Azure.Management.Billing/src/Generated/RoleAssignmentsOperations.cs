...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class RoleAssignmentsOperations : IServiceOperations<BillingManagementClient>, IRoleAssignmentsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal RoleAssignmentsOperations(BillingManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<BillingRoleAssignment>> PutWithHttpMessagesAsync(string billingAccountName, string billingRoleAssignmentName, BillingRoleAssignment parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
