...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// </summary>
    public partial class BillingSubscriptionsChangeInvoiceSectionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// BillingSubscriptionsChangeInvoiceSectionHeaders class.
        /// </summary>
        public BillingSubscriptionsChangeInvoiceSectionHeaders()
        {
            CustomInit();
        }
        ...
        public BillingSubscriptionsChangeInvoiceSectionHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
