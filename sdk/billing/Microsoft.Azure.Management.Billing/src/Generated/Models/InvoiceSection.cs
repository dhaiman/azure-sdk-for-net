...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    public partial class InvoiceSection : Resource
    {
        ...
        public InvoiceSection(string id = default(string), string name = default(string), string type = default(string), string displayName = default(string), string state = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string systemId = default(string), string targetCloud = default(string))
            : base(id, name, type)
        {
