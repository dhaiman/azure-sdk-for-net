...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// </summary>
    public partial class TransfersChangeInvoiceSectionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TransfersChangeInvoiceSectionHeaders class.
        /// </summary>
        public TransfersChangeInvoiceSectionHeaders()
        {
            CustomInit();
        }
        ...
        public TransfersChangeInvoiceSectionHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
