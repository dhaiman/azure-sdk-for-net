...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// </summary>
    public partial class InvoicesDownloadHeaders
    {
        /// <summary>
        /// Initializes a new instance of the InvoicesDownloadHeaders class.
        /// </summary>
        public InvoicesDownloadHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public InvoicesDownloadHeaders(string location = default(string), string retryAfter = default(string))
        {
            Location = location;
