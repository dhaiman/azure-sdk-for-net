...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// </summary>
    public partial class EaInvoicesDownloadHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EaInvoicesDownloadHeaders class.
        /// </summary>
        public EaInvoicesDownloadHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public EaInvoicesDownloadHeaders(string location = default(string), string retryAfter = default(string))
        {
            Location = location;
