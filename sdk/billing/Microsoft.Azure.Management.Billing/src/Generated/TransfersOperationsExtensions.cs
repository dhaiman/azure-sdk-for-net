...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class TransfersOperationsExtensions
    {
            ...
            /// </param>
            public static TransferDetails Initiate(this ITransfersOperations operations, string billingAccountName, string billingProfileName, string invoiceSectionName, string transferName, InitiateTransferRequest parameters)
            {
                return operations.InitiateAsync(billingAccountName, billingProfileName, invoiceSectionName, transferName, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TransferDetails> InitiateAsync(this ITransfersOperations operations, string billingAccountName, string billingProfileName, string invoiceSectionName, string transferName, InitiateTransferRequest parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.InitiateWithHttpMessagesAsync(billingAccountName, billingProfileName, invoiceSectionName, transferName, parameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
