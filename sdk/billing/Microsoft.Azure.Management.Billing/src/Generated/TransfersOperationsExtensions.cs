...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class TransfersOperationsExtensions
    {
            ...
            /// </param>
            public static TransfersChangeInvoiceSectionHeaders ChangeInvoiceSection(this ITransfersOperations operations, string billingAccountName, TransferBillingSubscriptionRequestProperties parameters)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TransfersChangeInvoiceSectionHeaders> ChangeInvoiceSectionAsync(this ITransfersOperations operations, string billingAccountName, TransferBillingSubscriptionRequestProperties parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
