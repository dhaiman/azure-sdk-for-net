      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_BillingManagementClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("Billing", "EnrollmentAccountRoleAssignments", "2020-05-01"),
                new Tuple<string, string, string>("Billing", "EnrollmentAccounts", "2018-03-01-preview"),
                new Tuple<string, string, string>("Billing", "EnrollmentDepartmentRoleAssignments", "2020-05-01"),
                ...
                new Tuple<string, string, string>("Billing", "RoleAssignments", "2020-05-01"),
