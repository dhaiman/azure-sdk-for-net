...
namespace Microsoft.Azure.Management.PostgreSQL.Models
{
    ...
    public partial class Configuration : ProxyResource
    {
        ...
        /// configuration.</param>
        public Configuration(string value, string id = default(string), string name = default(string), string type = default(string), string source = default(string), string description = default(string), string defaultValue = default(string), string dataType = default(string), string allowedValues = default(string))
            : base(id, name, type)
        {
            Value = value;
            Source = source;
