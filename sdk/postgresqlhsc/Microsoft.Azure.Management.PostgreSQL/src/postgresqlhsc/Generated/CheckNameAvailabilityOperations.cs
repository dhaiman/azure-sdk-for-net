...
namespace Microsoft.Azure.Management.PostgreSQL
{
    ...
    /// </summary>
    internal partial class CheckNameAvailabilityOperations : IServiceOperations<HyperscaleCitusManagementClient>, ICheckNameAvailabilityOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal CheckNameAvailabilityOperations(HyperscaleCitusManagementClient client)
        {
            if (client == null)
            {
