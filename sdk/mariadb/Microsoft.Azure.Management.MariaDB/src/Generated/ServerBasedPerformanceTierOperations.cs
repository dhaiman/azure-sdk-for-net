...
namespace Microsoft.Azure.Management.MariaDB
{
    ...
    /// </summary>
    internal partial class ServerBasedPerformanceTierOperations : IServiceOperations<MariaDBManagementClient>, IServerBasedPerformanceTierOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ServerBasedPerformanceTierOperations(MariaDBManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IEnumerable<PerformanceTierProperties>>> ListWithHttpMessagesAsync(string resourceGroupName, string serverName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForMariaDB/servers/{serverName}/performanceTiers").ToString();
