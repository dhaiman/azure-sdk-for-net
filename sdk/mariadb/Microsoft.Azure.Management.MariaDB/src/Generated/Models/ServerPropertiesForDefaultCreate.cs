...
namespace Microsoft.Azure.Management.MariaDB.Models
{
    ...
    public partial class ServerPropertiesForDefaultCreate : ServerPropertiesForCreate
    {
        ...
        public ServerPropertiesForDefaultCreate(string administratorLogin, string administratorLoginPassword, string version = default(string), SslEnforcementEnum? sslEnforcement = default(SslEnforcementEnum?), string minimalTlsVersion = default(string), string publicNetworkAccess = default(string), StorageProfile storageProfile = default(StorageProfile))
