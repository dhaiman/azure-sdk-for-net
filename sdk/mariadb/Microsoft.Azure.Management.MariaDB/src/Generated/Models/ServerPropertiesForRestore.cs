...
namespace Microsoft.Azure.Management.MariaDB.Models
{
    ...
    public partial class ServerPropertiesForRestore : ServerPropertiesForCreate
    {
        ...
        public ServerPropertiesForRestore(string sourceServerId, System.DateTime restorePointInTime, string version = default(string), SslEnforcementEnum? sslEnforcement = default(SslEnforcementEnum?), string minimalTlsVersion = default(string), string publicNetworkAccess = default(string), StorageProfile storageProfile = default(StorageProfile))
