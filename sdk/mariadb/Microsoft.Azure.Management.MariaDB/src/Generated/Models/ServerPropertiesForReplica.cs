...
namespace Microsoft.Azure.Management.MariaDB.Models
{
    ...
    public partial class ServerPropertiesForReplica : ServerPropertiesForCreate
    {
        ...
        public ServerPropertiesForReplica(string sourceServerId, string version = default(string), SslEnforcementEnum? sslEnforcement = default(SslEnforcementEnum?), string minimalTlsVersion = default(string), string publicNetworkAccess = default(string), StorageProfile storageProfile = default(StorageProfile))
