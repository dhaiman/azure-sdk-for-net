...
namespace Microsoft.Azure.Management.MariaDB.Models
{
    ...
    public partial class ServerPropertiesForCreate
    {
        ...
        public ServerPropertiesForCreate(string version = default(string), SslEnforcementEnum? sslEnforcement = default(SslEnforcementEnum?), string minimalTlsVersion = default(string), string publicNetworkAccess = default(string), StorageProfile storageProfile = default(StorageProfile))
        {
            Version = version;
