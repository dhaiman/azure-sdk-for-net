...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CustomIpPrefix : Resource
    {
        ...
        /// include the start address and the prefix length. Should be a subset
        /// of its master custom IP Prefix parent CIDR.</param>
        /// <param name="masterCustomIpPrefix">The master custom IP Prefix
        /// parent.</param>
        ...
        public CustomIpPrefix(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string cidr = default(string), SubResource masterCustomIpPrefix = default(SubResource), string commissionedState = default(string), IList<SubResource> publicIpPrefixes = default(IList<SubResource>), string resourceGuid = default(string), string provisioningState = default(string), string etag = default(string), IList<string> zones = default(IList<string>))
            : base(id, name, type, location, tags)
        {
            Cidr = cidr;
            MasterCustomIpPrefix = masterCustomIpPrefix;
        ...
        /// start address and the prefix length. Should be a subset of its
        /// master custom IP Prefix parent CIDR.
        /// </summary>
        [JsonProperty(PropertyName = "properties.cidr")]
        public string Cidr { get; set; }

        /// <summary>
        /// Gets or sets the master custom IP Prefix parent.
        /// </summary>
        [JsonProperty(PropertyName = "properties.masterCustomIpPrefix")]
        public SubResource MasterCustomIpPrefix { get; set; }

        /// <summary>
        /// Gets the commissioned state of the Custom IP Prefix. Possible
        /// values include: 'Provisioning', 'Provisioned', 'Commissioning',
        /// 'Commissioned', 'Decommissioning', 'Deprovisioning'
        /// </summary>
        [JsonProperty(PropertyName = "properties.commissionedState")]
        public string CommissionedState { get; private set; }
