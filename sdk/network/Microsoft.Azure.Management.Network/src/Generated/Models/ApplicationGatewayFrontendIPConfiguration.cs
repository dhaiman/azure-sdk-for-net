...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayFrontendIPConfiguration : SubResource
    {
        ...
        /// resource.</param>
        /// <param name="privateLinkResource">Reference to the application
        /// gateway private link resource.</param>
        ...
        public ApplicationGatewayFrontendIPConfiguration(string id = default(string), string privateIPAddress = default(string), string privateIPAllocationMethod = default(string), SubResource subnet = default(SubResource), SubResource publicIPAddress = default(SubResource), SubResource privateLinkResource = default(SubResource), string provisioningState = default(string), string name = default(string), string etag = default(string), string type = default(string))
            : base(id)
        {
        ...
        /// resource.
        /// </summary>
        [JsonProperty(PropertyName = "properties.privateLinkResource")]
