...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGateway : Resource
    {
        ...
        /// configured on application gateway.</param>
        ...
        /// <summary>
        /// Gets or sets private Link resources configured on application
        /// gateway.
        /// </summary>
        [JsonProperty(PropertyName = "properties.privateLinkResources")]
        public IList<ApplicationGatewayPrivateLinkResource> PrivateLinkResources { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element3 in PrivateLinkResources)
                {
                    if (element3 != null)
                    {
                        element3.Validate();
