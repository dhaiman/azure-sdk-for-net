...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ExpressRouteConnection : SubResource
    {
        ...
        /// security.</param>
        /// <param name="bypassExpressRouteGateway">Enable FastPath to vWan
        /// Firewall hub.</param>
        /// <param name="routingConfiguration">The Routing Configuration
        /// indicating the associated and propagated route tables on this
        /// connection.</param>
        public ExpressRouteConnection(ExpressRouteCircuitPeeringId expressRouteCircuitPeering, string name, string id = default(string), string provisioningState = default(string), string authorizationKey = default(string), int? routingWeight = default(int?), bool? enableInternetSecurity = default(bool?), bool? bypassExpressRouteGateway = default(bool?), RoutingConfiguration routingConfiguration = default(RoutingConfiguration))
            : base(id)
        {
            ...
            BypassExpressRouteGateway = bypassExpressRouteGateway;
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.bypassExpressRouteGateway")]
        public bool? BypassExpressRouteGateway { get; set; }
