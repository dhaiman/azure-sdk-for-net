...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class LoadBalancerBackendAddress
    {
        ...
        /// network.</param>
        /// <param name="ipAddress">IP Address belonging to the virtual network
        /// referenced above.</param>
        /// <param name="name">Name of the backend address</param>
        public LoadBalancerBackendAddress(SubResource virtualNetwork = default(SubResource), string ipAddress = default(string), string name = default(string))
        {
        ...
        /// <summary>
        /// Gets IP Address belonging to the virtual network referenced above.
        /// </summary>
