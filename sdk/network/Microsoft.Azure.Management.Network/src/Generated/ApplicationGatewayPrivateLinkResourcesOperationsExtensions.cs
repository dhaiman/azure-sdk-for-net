...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class ApplicationGatewayPrivateLinkResourcesOperationsExtensions
    {
            ...
            /// </param>
            public static ApplicationGatewayPrivateLinkResource Get(this IApplicationGatewayPrivateLinkResourcesOperations operations, string resourceGroupName, string applicationGatewayName, string privateLinkResourceName)
            {
                return operations.GetAsync(resourceGroupName, applicationGatewayName, privateLinkResourceName).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<ApplicationGatewayPrivateLinkResource> GetAsync(this IApplicationGatewayPrivateLinkResourcesOperations operations, string resourceGroupName, string applicationGatewayName, string privateLinkResourceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetWithHttpMessagesAsync(resourceGroupName, applicationGatewayName, privateLinkResourceName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
