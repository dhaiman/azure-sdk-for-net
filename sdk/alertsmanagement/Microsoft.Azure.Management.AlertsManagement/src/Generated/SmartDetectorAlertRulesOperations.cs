...
namespace Microsoft.Azure.Management.AlertsManagement
{
    ...
    internal partial class SmartDetectorAlertRulesOperations : IServiceOperations<AlertsManagementClient>, ISmartDetectorAlertRulesOperations
    {
        ...
        /// </param>
        /// <exception cref="ErrorResponse1Exception">
        ...
        {
            if (Client.SubscriptionIdTestTest == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionIdTestTest");
            }
            if (Client.SubscriptionIdTestTest != null)
            {
                if (Client.SubscriptionIdTestTest.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "Client.SubscriptionIdTestTest", 1);
                }
            }
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/test/microsoft.alertsManagement/smartDetectorAlertRules").ToString();
            _url = _url.Replace("{subscriptionId-test-test}", System.Uri.EscapeDataString(Client.SubscriptionIdTestTest));
            ...
            {
                var ex = new ErrorResponse1Exception(string.Format("Operation returned an invalid status code '{0}'", _statusCode));
                try
                {
                    _responseContent = await _httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                    ErrorResponse1 _errorBody =  Rest.Serialization.SafeJsonConvert.DeserializeObject<ErrorResponse1>(_responseContent, Client.DeserializationSettings);
                    if (_errorBody != null)
                    {
                        ex.Body = _errorBody;
                    }
