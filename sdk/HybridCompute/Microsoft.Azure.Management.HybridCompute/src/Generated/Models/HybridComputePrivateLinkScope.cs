...
namespace Microsoft.Azure.Management.HybridCompute.Models
{
    ...
    public partial class HybridComputePrivateLinkScope : PrivateLinkScopesResource
    {
        ...
        /// connections.</param>
        public HybridComputePrivateLinkScope(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string provisioningState = default(string), IList<PrivateEndpointConnection> privateEndpointConnections = default(IList<PrivateEndpointConnection>))
