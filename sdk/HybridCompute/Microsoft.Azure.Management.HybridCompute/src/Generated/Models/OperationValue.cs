...
namespace Microsoft.Azure.Management.HybridCompute.Models
{
    ...
    public partial class OperationValue
    {
        ...
        /// to data-plane</param>
        public OperationValue(string origin = default(string), string name = default(string), string operation = default(string), string resource = default(string), string description = default(string), string provider = default(string), string isDataAction = default(string))
        {
            Origin = origin;
            Name = name;
            Operation = operation;
        ...
        /// <summary>
        /// Gets indicates whether the operation applies to data-plane
        /// </summary>
        [JsonProperty(PropertyName = "isDataAction")]
        public string IsDataAction { get; private set; }
