...
namespace Microsoft.Azure.Management.Subscription.Models
{
    ...
    /// </summary>
    public partial class SubscriptionPutSubscriptionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SubscriptionPutSubscriptionHeaders class.
        /// </summary>
        public SubscriptionPutSubscriptionHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public SubscriptionPutSubscriptionHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
