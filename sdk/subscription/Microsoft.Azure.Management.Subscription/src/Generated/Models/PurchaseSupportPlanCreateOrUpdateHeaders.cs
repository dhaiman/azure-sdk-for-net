...
namespace Microsoft.Azure.Management.Subscription.Models
{
    ...
    /// </summary>
    public partial class PurchaseSupportPlanCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PurchaseSupportPlanCreateOrUpdateHeaders class.
        /// </summary>
        public PurchaseSupportPlanCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public PurchaseSupportPlanCreateOrUpdateHeaders(string location = default(string), string retryAfter = default(string))
        {
            Location = location;
