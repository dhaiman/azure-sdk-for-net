...
namespace Microsoft.Azure.Management.Subscription.Models
{
    ...
    /// </summary>
    public partial class SubscriptionGetSubscriptionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SubscriptionGetSubscriptionHeaders class.
        /// </summary>
        public SubscriptionGetSubscriptionHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public SubscriptionGetSubscriptionHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
