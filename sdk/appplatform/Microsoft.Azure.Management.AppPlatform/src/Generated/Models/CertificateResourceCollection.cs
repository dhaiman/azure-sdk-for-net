...
namespace Microsoft.Azure.Management.AppPlatform.Models
{
    ...
    public partial class CertificateResourceCollection
    {
        ...
        /// list.</param>
        public CertificateResourceCollection(IList<CertificateResourceCollection> resources = default(IList<CertificateResourceCollection>), string nextLink = default(string))
        {
            Resources = resources;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<CertificateResourceCollection> Resources { get; set; }
