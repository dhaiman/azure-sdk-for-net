...
namespace Microsoft.Azure.Management.AppPlatform.Models
{
    ...
    public partial class ServiceResource : TrackedResource
    {
        ...
        /// <param name="identity">The Managed Identity of the service
        /// resource.</param>
        /// <param name="sku">Sku of the Service resource</param>
        public ServiceResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), ClusterResourceProperties properties = default(ClusterResourceProperties), ManagedIdentityProperties identity = default(ManagedIdentityProperties), Sku sku = default(Sku))
        ...
        /// <summary>
        /// Gets or sets the Managed Identity of the service resource.
        /// </summary>
