...
namespace Microsoft.Azure.Management.AppPlatform
{
    ...
    public static partial class CertificatesOperationsExtensions
    {
            ...
            /// The name of the certificate resource.
            /// </param>
            public static IPage<CertificateResource> List(this ICertificatesOperations operations, string resourceGroupName, string serviceName, string certificateName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<CertificateResource>> ListAsync(this ICertificatesOperations operations, string resourceGroupName, string serviceName, string certificateName, CancellationToken cancellationToken = default(CancellationToken))
            {
