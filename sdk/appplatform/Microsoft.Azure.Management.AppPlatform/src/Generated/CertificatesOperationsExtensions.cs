...
namespace Microsoft.Azure.Management.AppPlatform
{
    ...
    public static partial class CertificatesOperationsExtensions
    {
            ...
            /// The name of the Service resource.
            /// </param>
            public static CertificateResourceCollection List(this ICertificatesOperations operations, string resourceGroupName, string serviceName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<CertificateResourceCollection> ListAsync(this ICertificatesOperations operations, string resourceGroupName, string serviceName, CancellationToken cancellationToken = default(CancellationToken))
            {
